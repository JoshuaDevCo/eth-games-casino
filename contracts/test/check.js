...
describe("Arbetrum", function () {
    ...
    describe("sArbet", function () {
        ...
        it("distrbute token", async function () {
            let i
            for (i = 1; i < 10; i++) {
    ...
    describe("USDTVault", function () {
        ...
        it("distrbute USDT, Arbet", async function () {
            let i
            for (i = 1; i < 10; i++) {
    ...
    describe("Game", function () {
        ...
        before("", async function () {
            ...
            const diceInfo = await deployContract("GameDice", usdtInfo.imple, vaultInfo.imple, consoleInfo.imple, houseInfo.imple, rngInfo.imple, 0, 1)
        ...
        it ("play dice game", async function () {
            ...
            const rolls = 1
            let tx = await diceContract.connect(user1).play(rolls, 67, Array.from({ length: 50 }).map((u, i) => 0), T2B('0.1'))
